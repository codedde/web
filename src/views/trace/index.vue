<template>
  <div class="trace-container">
    ...
    <el-button type="success" plain @click="AllFruitInfo"> 获取所有食品信息 </el-button>
    <el-table
      :data="tracedata"
      style="width: 100%"
    >
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <div><span class="trace-text" style="color: #67C23A;">食品信息</span></div>
            ...
            <div><span class="trace-text" style="color: #909399;">销售商信息</span></div>
            ...
            <el-form-item label="销售商位置：">
              <span>{{ props.row.shop_input.sh_shopAddress }}</span>
            </el-form-item>
            <el-form-item label="销售商电话：">
